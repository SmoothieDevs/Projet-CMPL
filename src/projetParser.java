// $ANTLR 3.5.2 C:\\Users\\willi\\Documents\\Licence 3\\CMPL\\TP Projet\\src\\projet.g 2023-03-24 14:47:26
...
public class projetParser extends Parser {
	...
	public final void parfixe() throws RecognitionException {
		try {
			...
			{
			match(input,41,FOLLOW_41_in_parfixe530); 
		...
		try {
			...
			switch (alt29) {
				case 1 :
					...
					{
					PtGen.pt(81);
					match(input,52,FOLLOW_52_in_inssi732); 
					pushFollow(FOLLOW_instructions_in_inssi735);
					instructions();
					state._fsp--;
			...
			match(input,42,FOLLOW_42_in_inssi739); 
			PtGen.pt(82);
			}
	...
	public final void inscond() throws RecognitionException {
		try {
			...
			{
			match(input,28,FOLLOW_28_in_inscond754); 
			PtGen.pt(78);
			pushFollow(FOLLOW_expression_in_inscond758);
			expression();
			state._fsp--;
			...
			switch (alt31) {
				case 1 :
					...
					{
					PtGen.pt(79);
					match(input,26,FOLLOW_26_in_inscond808); 
	...
	public final void boucle() throws RecognitionException {
		try {
			...
			{
			match(input,53,FOLLOW_53_in_boucle846); 
			PtGen.pt(83);
	...
	public final void lecture() throws RecognitionException {
		try {
			...
			{
			match(input,43,FOLLOW_43_in_lecture873); 
			match(input,10,FOLLOW_10_in_lecture875); 
			...
			while (true) {
				...
				case 1 :
					...
					{
					match(input,14,FOLLOW_14_in_lecture883); 
			...
			match(input,11,FOLLOW_11_in_lecture892); 
			}
	...
	public final void ecriture() throws RecognitionException {
		try {
			...
			{
			match(input,33,FOLLOW_33_in_ecriture905); 
			match(input,10,FOLLOW_10_in_ecriture907); 
			...
			match(input,11,FOLLOW_11_in_ecriture925); 
			}
	...
	public final void affouappel() throws RecognitionException {
		try {
			...
			{
			pushFollow(FOLLOW_ident_in_affouappel941);
			ident();
			state._fsp--;
			...
			switch (alt36) {
				case 1 :
					...
					pushFollow(FOLLOW_expression_in_affouappel953);
					expression();
					state._fsp--;
				...
				case 2 :
					...
					switch (alt35) {
						case 1 :
							...
							{
							pushFollow(FOLLOW_effixes_in_affouappel974);
							effixes();
							state._fsp--;
							...
							switch (alt34) {
								case 1 :
									...
									{
									pushFollow(FOLLOW_effmods_in_affouappel977);
									effmods();
									state._fsp--;
	...
	public final void effixes() throws RecognitionException {
		try {
			...
			{
			match(input,10,FOLLOW_10_in_effixes1011); 
				...
				case 1 :
					...
					while (true) {
						...
						case 1 :
							...
							{
							match(input,14,FOLLOW_14_in_effixes1019); 
				...
				case 1 :
					...
					while (true) {
						...
						case 1 :
							...
							{
							match(input,14,FOLLOW_14_in_effmods1050); 
		...
		try {
			...
			switch (alt44) {
				case 1 :
					...
					{
					match(input,22,FOLLOW_22_in_exp31165); 
					PtGen.pt(60);
				...
				case 4 :
					...
					{
					match(input,24,FOLLOW_24_in_exp31206); 
					PtGen.pt(60);
		...
		try {
			...
			switch (alt47) {
				case 1 :
					...
					{
					pushFollow(FOLLOW_valeur_in_primaire1394);
					valeur();
					state._fsp--;
				...
				case 2 :
					...
					{
					pushFollow(FOLLOW_ident_in_primaire1402);
					ident();
					state._fsp--;
				...
				case 3 :
					...
					{
					match(input,10,FOLLOW_10_in_primaire1410); 
					pushFollow(FOLLOW_expression_in_primaire1412);
					expression();
					state._fsp--;

					match(input,11,FOLLOW_11_in_primaire1414); 
					}
					break;
		...
		try {
			...
			switch (alt48) {
				...
				case 2 :
					...
					{
					match(input,13,FOLLOW_13_in_valeur1436); 
				...
				case 3 :
					...
					{
					match(input,15,FOLLOW_15_in_valeur1446); 
				...
				case 4 :
					...
					{
					match(input,55,FOLLOW_55_in_valeur1456); 
					PtGen.pt(5);
					}
					break;
				case 5 :
					...
					{
					match(input,38,FOLLOW_38_in_valeur1464); 
					PtGen.pt(6);
					}
					break;
	...
	public final void nbentier() throws RecognitionException {
		...
		try {
			...
			{
			INT1=(Token)match(input,INT,FOLLOW_INT_in_nbentier1494); 
	...
	public final void ident() throws RecognitionException {
		...
		try {
			...
			{
			ID2=(Token)match(input,ID,FOLLOW_ID_in_ident1505); 
	...
	public static final BitSet FOLLOW_41_in_parfixe530 = new BitSet(new long[]{0x0000000000000400L});
	public static final BitSet FOLLOW_10_in_parfixe532 = new BitSet(new long[]{0x0000000408000000L});
	...
	public static final BitSet FOLLOW_52_in_inssi732 = new BitSet(new long[]{0x0028080210040020L});
	public static final BitSet FOLLOW_instructions_in_inssi735 = new BitSet(new long[]{0x0000040000000000L});
	public static final BitSet FOLLOW_42_in_inssi739 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_28_in_inscond754 = new BitSet(new long[]{0x008040400000A460L});
	public static final BitSet FOLLOW_expression_in_inscond758 = new BitSet(new long[]{0x0000000000010000L});
	...
	public static final BitSet FOLLOW_26_in_inscond808 = new BitSet(new long[]{0x0028080210040020L});
	...
	public static final BitSet FOLLOW_53_in_boucle846 = new BitSet(new long[]{0x008040400000A460L});
	...
	public static final BitSet FOLLOW_43_in_lecture873 = new BitSet(new long[]{0x0000000000000400L});
	public static final BitSet FOLLOW_10_in_lecture875 = new BitSet(new long[]{0x0000000000000020L});
	public static final BitSet FOLLOW_ident_in_lecture877 = new BitSet(new long[]{0x0000000000004800L});
	public static final BitSet FOLLOW_14_in_lecture883 = new BitSet(new long[]{0x0000000000000020L});
	public static final BitSet FOLLOW_ident_in_lecture885 = new BitSet(new long[]{0x0000000000004800L});
	public static final BitSet FOLLOW_11_in_lecture892 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_33_in_ecriture905 = new BitSet(new long[]{0x0000000000000400L});
	public static final BitSet FOLLOW_10_in_ecriture907 = new BitSet(new long[]{0x008040400000A460L});
	...
	public static final BitSet FOLLOW_11_in_ecriture925 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_ident_in_affouappel941 = new BitSet(new long[]{0x0000000000020402L});
	public static final BitSet FOLLOW_17_in_affouappel951 = new BitSet(new long[]{0x008040400000A460L});
	public static final BitSet FOLLOW_expression_in_affouappel953 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_effixes_in_affouappel974 = new BitSet(new long[]{0x0000000000000402L});
	public static final BitSet FOLLOW_effmods_in_affouappel977 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_10_in_effixes1011 = new BitSet(new long[]{0x008040400000AC60L});
	public static final BitSet FOLLOW_expression_in_effixes1014 = new BitSet(new long[]{0x0000000000004800L});
	public static final BitSet FOLLOW_14_in_effixes1019 = new BitSet(new long[]{0x008040400000A460L});
	...
	public static final BitSet FOLLOW_14_in_effmods1050 = new BitSet(new long[]{0x0000000000000020L});
	...
	public static final BitSet FOLLOW_exp4_in_exp31158 = new BitSet(new long[]{0x0000000001F80002L});
	public static final BitSet FOLLOW_22_in_exp31165 = new BitSet(new long[]{0x008000400000A460L});
	...
	public static final BitSet FOLLOW_24_in_exp31206 = new BitSet(new long[]{0x008000400000A460L});
	...
	public static final BitSet FOLLOW_valeur_in_primaire1394 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_ident_in_primaire1402 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_10_in_primaire1410 = new BitSet(new long[]{0x008040400000A460L});
	public static final BitSet FOLLOW_expression_in_primaire1412 = new BitSet(new long[]{0x0000000000000800L});
	public static final BitSet FOLLOW_11_in_primaire1414 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_nbentier_in_valeur1428 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_13_in_valeur1436 = new BitSet(new long[]{0x0000000000000040L});
	public static final BitSet FOLLOW_nbentier_in_valeur1438 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_15_in_valeur1446 = new BitSet(new long[]{0x0000000000000040L});
	public static final BitSet FOLLOW_nbentier_in_valeur1448 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_55_in_valeur1456 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_38_in_valeur1464 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_INT_in_nbentier1494 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_ID_in_ident1505 = new BitSet(new long[]{0x0000000000000002L});
}
